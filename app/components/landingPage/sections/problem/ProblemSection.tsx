export const ProblemSection = () => (
  <>
    <div className="px-8 py-8 lg:py-32 flex flex-col gap-6 md:gap-8 justify-center items-center text-center">
      <h2 className="text-center text-5xl font-extrabold">
        sit amet consectetur adipisicing elit.
      </h2>
      <p className="max-w-xl mx-auto text-lg opacity-80 leading-relaxed">
